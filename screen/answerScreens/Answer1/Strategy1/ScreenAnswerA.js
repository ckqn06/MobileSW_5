...
//TODO
//create a new UI screen for answers

const ScreenAnswerA = ({ navigation }) => {
    ...
    let instructionText = "OK. Using p to represent the number of pictures, write an equation that represents how p, $7.50 per picture, and the $3.25 shipping fee combine to make $85.75";
    ...
    const checkAnswer = () => {
        ...
        inputAnswer.trim() == "85.75=3.25+7.5*p" ?
    ...
    return (
        ...
        >
            ...
            <ModalCustom 
                ...
                toNavigateScreen2="Answer A-2"
                text1="Nice Job!"
                text2 = "Would you like to move to the next step?"
            />
