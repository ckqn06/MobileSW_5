...
const Strate1_1 = (props) => {
    ...
    const correct1 = () => {
        if (myTextInput1_1==85.75 &&
            (myTextInput1_2==3.25 && (category == '+') && (myTextInput1_3=='7.5*p' || myTextInput1_3=='p*7.5' || myTextInput1_3=='7.5p' || myTextInput1_3=='p7.5')) ||
            (myTextInput1_3==3.25 && (category == '+') && (myTextInput1_2=='7.5*p' || myTextInput1_2=='p*7.5' || myTextInput1_2=='7.5p' || myTextInput1_2=='p7.5'))) {
            alert("next");
            setShow(true)}
        else {
            if(count1 > 0) {
