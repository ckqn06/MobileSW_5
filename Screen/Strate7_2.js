...
import { up7, change7_2 } from "../Redux/Actions";
        ...
        <ScrollView style ={{width:"100%"}}>    
            <View style = {styles.container}>
                ...
                <View>
                    ...
                    Cool, so he’s paying $25 in mileage. How many days do you think he can rent the car for? 
                    </Text>
                    <TextInput
                    style = {styles.input}
                    placeholder="answer."
                ...
                {show2 ? (
                    ...
                    <Text style = {styles.text}>
                    Ok, so you think that he can rent it for [x] days. How much would Jim pay in total?
                    </Text>
                    <TextInput
                    style = {styles.input}
                    placeholder="answer."
