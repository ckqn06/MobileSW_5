...
const Strate6_1 = (props) => {
    ...
    const correct1 = () => {
        if (myTextInput1_3==104 &&
            (myTextInput1_1==24 && (category == '+') && (myTextInput1_2=='4*x' || myTextInput1_2=='x*4' || myTextInput1_2=='4x' || myTextInput1_2=='x4')) ||
            (myTextInput1_2==24 && (category == '+') && (myTextInput1_1=='4*x' || myTextInput1_1=='x*4' || myTextInput1_1=='4x' || myTextInput1_1=='x4'))) {
            alert("next");
            setShow(true) }
        else {
            if(count1 > 0) {
