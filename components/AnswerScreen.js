...
import ModalHandler from "./ModalCustom";

const AnswerScreenB = ({ navigation }) => {
    ...
    let instructionText = "OK, let's try that. Start from $3.25. How many times do you have to add $7.50 to get to $85.75?";
    //let instruction2 = "Some text"
    ...
    return (
        ...
        >
            ...
            <ModalHandler 
                ...
                text1="Fantastic"
                text2 = "Would you like to move to try another strategy?"
            />
